...
chear_kol = store[goods['Стул']][0]['quantity'] + store[goods['Стул']][1]['quantity'] + store[goods['Стул']][2]['quantity']
print(f'Лампа - {lamps_kol} шт, стоимость {lamps_cost} руб')
print(f'Стол - {table_kol} шт, стоимость - {table_cost} руб')
print('Диван -', sofa_kol, 'шт, стоимость', sofa_cost, 'руб')
print('Стул -', chear_kol, 'шт, стоимость', chear_cost, 'руб')
